                        ...
                        <div class="card card-registration my-4">
                            <div class="row g-0">
                                <div class="card-body p-md-5 text-black">
                                    <h2 class="mb-5 text-uppercase text-primary text-center">Product Variation Option</h2>
                                    <div class="row">
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    @php
                                    $startIndex = ($variation_option->currentPage() - 1) * $variation_option->perPage() + 1;
                                    @endphp
                                    @foreach ($variation_option as $variation)
                                    <tr>
                                        <td>{{ $startIndex++ }}</td>
